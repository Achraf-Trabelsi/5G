...
% Tunable parameters
tp.mobileRange = 5750;    % m
tp.mobileAngle = 60;       % degrees
tp.numTXElements = 8;       
tp.steeringAngle = 50;     % degrees
tp.rxGain = 108.8320 - tp.txGain; % dB
...
%Define OFDM modulation parameters
...
for uIdx = 1:prm.numUsers
    ...
    spLoss(uIdx) = fspl(toRxRange,prm.lambda); %Free space path loss
end
